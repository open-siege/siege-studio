...
namespace studio::resources::vol::three_space
{
  struct rmf_file_archive : studio::resources::archive_plugin
  {
    ...
    std::vector<std::variant<studio::resources::folder_info, studio::resources::file_info>> get_content_listing(std::basic_istream<std::byte>& stream, const listing_query& query) const override;
