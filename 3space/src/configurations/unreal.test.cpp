...
namespace unreal = studio::configurations::unreal;

using namespace std::literals;

TEST_CASE("Parsing of an unreal config file", "[cfg.unreal]")
{
  SECTION("With sample unreal data, values convert correctly")
  {
