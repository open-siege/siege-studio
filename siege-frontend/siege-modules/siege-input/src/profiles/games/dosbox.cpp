...
namespace siege
{
    ...
    std::vector<game_config> convert_to_dosbox_config(std::vector<joystick_info> joysticks)
    {
        ...
        results.emplace_back("dosbox.cfg", text_game_config(studio::configurations::dosbox::config::save_config));
        results.emplace_back("mapper.cfg", text_game_config(studio::configurations::dosbox::mapper::save_config));
