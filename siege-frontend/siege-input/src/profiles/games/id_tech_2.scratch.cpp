...
{
    constexpr static auto controller_button_mapping = std::array<std::array<std::string_view, 2>, 12> {{
...
// set AXIS "BINDING"
constexpr static auto joystick_axis = std::array<std::string_view, 5> {{
    "joy_advaxisx", 
    "joy_advaxisy",
    "joy_advaxisz", 
    "joy_advaxisr", 
