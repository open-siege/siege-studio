...
namespace nlohmann
{
  ...
  struct adl_serializer<siege::platform::endian_int_t<ByteOrder, IntType, Size>>
  {
    using EndianType = siege::platform::endian_int_t<ByteOrder, IntType, Size>;
...
namespace siege
{
  using siege::content::to_json;
  using siege::content::from_json;
}// namespace siege
