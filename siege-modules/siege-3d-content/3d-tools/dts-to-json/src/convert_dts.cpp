...
//#include <siege/content/dts/dts_json_formatting.hpp"

namespace fs = std::filesystem;
namespace dts2 = siege::content::dts::three_space;
namespace dts3 = siege::content::dts::darkstar;
...
//
//            std::vector<dts::group_item> groups = siege::shared::transform_variants<dts::group_item>(real_shape.base.parts);
//
...
//                std::vector<dts::poly_item> polys = siege::shared::transform_variants<dts::poly_item>(real_group.items);
//
