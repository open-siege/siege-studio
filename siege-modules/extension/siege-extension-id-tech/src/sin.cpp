...
extern auto network_backends = std::array<const wchar_t*, 2>{ { L"ws2_32" } };
  ...
  std::array<std::pair<WORD, std::string_view>, 23> actions{
    {
      ...
      std::make_pair<WORD, std::string_view>(VK_GAMEPAD_LEFT_TRIGGER, "weaponuse"),
      ...
      std::make_pair<WORD, std::string_view>(VK_GAMEPAD_VIEW, "showinfo"),
      std::make_pair<WORD, std::string_view>(VK_GAMEPAD_MENU, "showhelp"),
    }
  };
