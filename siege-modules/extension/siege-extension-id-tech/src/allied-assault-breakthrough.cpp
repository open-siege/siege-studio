...
extern auto command_line_caps = game_command_line_caps{
  .int_settings = { { L"r_customwidth", L"r_customheight", L"r_mode", L"in_joystick", L"r_usepixo", L"g_gametype" } },
  ...
  get_predefined_int_command_line_settings(const wchar_t* name) noexcept
{
  ...
  if (name_str == L"r_usepixo")
  {
    static auto modes = std::array<predefined_int, 8>{
      predefined_int{ .label = L"Disabled", .value = 0 },
      predefined_int{ .label = L"Enabled - Full-res", .value = 1 },
      predefined_int{ .label = L"Enabled - Half-res (width+height)", .value = 2 },
      predefined_int{ .label = L"Enabled - Half-res (height)", .value = 3 },
      predefined_int{},
    };
  ...
  if (name_str == L"g_gametype")
  {
    static auto modes = std::array<predefined_int, 8>{
      ...
      predefined_int{ .label = L"Liberation", .value = 6 },
      predefined_int{},
    };
