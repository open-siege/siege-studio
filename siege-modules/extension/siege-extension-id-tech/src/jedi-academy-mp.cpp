...
std::errc init_mouse_inputs(mouse_binding* binding)
{
  ...
  auto config = load_config_from_pk3(L"base\\mpdefault.cfg", L"base/assets2.pk3", L"base/assets2.pk3");
...
std::errc init_keyboard_inputs(keyboard_binding* binding)
{
  ...
  auto config = load_config_from_pk3(L"base\\mpdefault.cfg", L"base/assets0.pk3", L"base/assets0.pk3");
