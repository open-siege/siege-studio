...
TEST_CASE("Integration tests for winsock rpc clients", "[wsock32]")
{
  SECTION("wsock32 socket tests")
  {
    ::SetEnvironmentVariableW(L"ZERO_TIER_NETWORK_ID", L"000000");
    ::SetEnvironmentVariableW(L"WSOCK_RPC_BACKEND", L"wsock32.dll");
    auto module = win32::module("wsock32-rpc-client.dll");
    ...
    WSAData info{};
    auto result = startup(MAKEWORD(1, 1), &info);
    REQUIRE(result == 0);
