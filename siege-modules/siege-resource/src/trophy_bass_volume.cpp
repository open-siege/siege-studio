...
namespace siege::resource::vol::trophy_bass
{
  ...
  std::vector<std::variant<folder_info, siege::platform::file_info>> rbx_file_archive::get_content_listing(std::istream& stream, const platform::listing_query& query) const
  {
  ...
  void rbx_file_archive::set_stream_position(std::istream& stream, const siege::platform::file_info& info) const
  {
    if (std::size_t(stream.tellg()) == info.offset)
    {
  ...
  std::vector<rbx_file_archive::content_info> tbv_file_archive::get_content_listing(std::istream& stream, const platform::listing_query& query) const
  {
    std::vector<siege::platform::file_info> results;
  ...
  void tbv_file_archive::set_stream_position(std::istream& stream, const siege::platform::file_info& info) const
  {
    if (std::size_t(stream.tellg()) == info.offset)
    {
