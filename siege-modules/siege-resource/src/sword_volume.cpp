...
namespace siege::resource::atd
{
  ...
  std::vector<atd_file_archive::content_info> atd_file_archive::get_content_listing(std::istream& stream, const platform::listing_query& query) const
  {
  ...
  void atd_file_archive::set_stream_position(std::istream& stream, const siege::platform::file_info& info) const
  {
