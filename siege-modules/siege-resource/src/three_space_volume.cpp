...
namespace siege::resource::vol::three_space
{
  ...
  std::vector<rmf_file_archive::content_info> rmf_file_archive::get_content_listing(std::istream& stream, const platform::listing_query& query) const
  {
  ...
  void rmf_file_archive::set_stream_position(std::istream& stream, const siege::platform::file_info& info) const
  {
  ...
  std::vector<dyn_file_archive::content_info> dyn_file_archive::get_content_listing(std::istream& stream, const platform::listing_query& query) const
  {
  ...
  void dyn_file_archive::set_stream_position(std::istream& stream, const siege::platform::file_info& info) const
  {
    constexpr auto header_size = sizeof(std::array<std::byte, 13>) + sizeof(endian::little_int32_t);
  ...
  std::vector<dyn_file_archive::content_info> vol_file_archive::get_content_listing(std::istream& stream, const platform::listing_query& query) const
  {
    std::vector<dyn_file_archive::content_info> results;
  ...
  void vol_file_archive::set_stream_position(std::istream& stream, const siege::platform::file_info& info) const
  {
    if (std::size_t(stream.tellg()) == info.offset)
    {
      stream.seekg(header_size, std::ios::cur);
