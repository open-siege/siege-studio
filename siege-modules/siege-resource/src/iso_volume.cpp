...
namespace siege::resource::iso
{
  ...
  constexpr auto cue_file_record_tag = platform::to_tag<4>({ 'F', 'I', 'L', 'E' });
  constexpr auto ccd_file_record_tag = platform::to_tag<9>({ '[', 'C', 'l', 'o', 'n', 'e', 'C', 'D', ']' });
  constexpr auto mds_file_record_tag = platform::to_tag<16>({ 'M', 'E', 'D', 'I', 'A', ' ', 'D', 'E', 'S', 'C', 'R', 'I', 'P', 'T', 'O', 'R' });
  ...
  constexpr auto common_data_pattern = platform::to_tag<12>({ 0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x00 });
  ...
  //  test_track-2.cdda
  //  test_track-3.cdda
  std::vector<iso_file_archive::content_info> cue_get_content_listing(std::istream& input, const platform::listing_query& query)
  {
  ...
  std::vector<iso_file_archive::content_info> mds_get_content_listing(std::istream& input, const platform::listing_query& query)
  {
    std::vector<iso_file_archive::content_info> results;
  ...
  std::vector<iso_file_archive::content_info> iso_file_archive::get_content_listing(std::istream& stream, const platform::listing_query& query) const
  {
    return iso_get_content_listing(query);
  }

  void iso_file_archive::set_stream_position(std::istream& stream, const siege::platform::file_info& info) const
  {
  }
