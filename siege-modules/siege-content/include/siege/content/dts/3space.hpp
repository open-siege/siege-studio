...
namespace siege::content::dts::three_space
{
  ...
  namespace v1
  {
    ...
    struct base_part
    {
      ...
      KEYS_CONSTEXPR static auto keys = platform::make_keys({ "transform", "idNumber", "radius", "center" });
    ...
    struct group
    {
      ...
      constexpr static auto version = 1;
      KEYS_CONSTEXPR static auto keys = platform::make_keys({ "base", "indexCount", "pointCount", "colorCount", "itemCount", "indexes", "points", "colors", "items" });
    ...
    struct bsp_group
    {
      ...
      constexpr static auto version = 1;
      KEYS_CONSTEXPR static auto keys = platform::make_keys({ "base", "nodeCount", "nodes" });
      struct bsp_group_node
      {
        KEYS_CONSTEXPR static auto keys = platform::make_keys({ "coeff", "poly", "front", "back" });
    ...
    struct bitmap_part
    {
      ...
      constexpr static auto version = 1;
      KEYS_CONSTEXPR static auto keys = platform::make_keys({ "base", "bmpTag", "xOffset", "yOffset" });
    ...
    struct poly
    {
      ...
      constexpr static auto version = 1;
      KEYS_CONSTEXPR static auto keys = platform::make_keys({ "normal", "center", "vertexCount", "vertexList" });
    ...
    struct solid_poly
    {
      ...
      constexpr static auto version = 1;
      KEYS_CONSTEXPR static auto keys = platform::make_keys({ "base", "colors" });
      poly base;
    ...
    struct gouraud_poly
    {
      ...
      constexpr static auto version = 1;
      KEYS_CONSTEXPR static auto keys = platform::make_keys({ "base", "normal_list" });
      solid_poly base;
    ...
    struct texture_for_poly
    {
      ...
      constexpr static auto version = 1;
      KEYS_CONSTEXPR static auto keys = platform::make_keys({ "base" });
      solid_poly base;
    };
    ...
    struct part_list
    {
      ...
      constexpr static auto version = 1;
      KEYS_CONSTEXPR static auto keys = platform::make_keys({ "base", "partCount", "parts" });
      base_part base;
    ...
    struct shape
    {
      ...
      constexpr static auto version = 1;
      KEYS_CONSTEXPR static auto keys = platform::make_keys({ "base", "transformListCount", "sequenceListCount", "sequences", "transforms", "extraParts" });
      part_list base;
    ...
    struct detail_part
    {
      ...
      constexpr static auto version = 1;
      KEYS_CONSTEXPR static auto keys = platform::make_keys({ "base", "detailCount", "details" });
      part_list base;
    ...
    struct cell_anim_part
    {
      ...
      constexpr static auto version = 1;
      KEYS_CONSTEXPR static auto keys = platform::make_keys({ "base", "animSequence" });
      part_list base;
    ...
    struct bsp_part
    {
      ...
      constexpr static auto version = 1;
      KEYS_CONSTEXPR static auto keys = platform::make_keys({ "base", "nodeCount", "nodes", "transforms" });

      struct bsp_node
      {
        KEYS_CONSTEXPR static auto keys = platform::make_keys({ "normal", "coeff", "front", "back" });
        vector3s normal;
        endian::little_int32_t coeff;
        endian::little_int16_t front;
        endian::little_int16_t back;
    ...
    struct an_sequence
    {
      ...
      constexpr static auto version = 1;
      KEYS_CONSTEXPR static auto keys = platform::make_keys({ "tick", "priority", "gm", "frameCount", "frames", "partListCount", "parts", "transformIndexes" });

      struct frame
      {
        KEYS_CONSTEXPR static auto keys = platform::make_keys({ "tick", "firstTransition", "transitionCount" });
    ...
    struct an_anim_list
    {
      ...
      constexpr static auto version = 1;
      KEYS_CONSTEXPR static auto keys = platform::make_keys({ "sequenceCount", "sequences", "transitionCount", "transitions", "transformCount", "transforms", "defaultTransformCount", "defaultTransforms", "relationsCount", "relations" });

      struct transition
      {
        KEYS_CONSTEXPR static auto keys = platform::make_keys({ "tick", "destSequence", "destFrame", "groundMovement" });
        endian::little_uint16_t tick;
      ...
      struct transform
      {
        KEYS_CONSTEXPR static auto keys = platform::make_keys({ "rx", "ry", "rz", "tx", "ty", "tz" });
      ...
      struct relation
      {
        KEYS_CONSTEXPR static auto keys = platform::make_keys({ "parent", "destination" });
