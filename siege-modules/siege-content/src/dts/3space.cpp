...
namespace siege::content::dts::three_space
{
  ...
  namespace v1
  {
    constexpr file_tag grid_shape_tag = platform::to_tag<4>({ 0x01, 0x00, 0xbc, 0x02 });
    constexpr file_tag rectangle_region_tag = platform::to_tag<4>({ 0x0c, 0x00, 0x28, 0x00 });
    constexpr file_tag edge_table_tag = platform::to_tag<4>({ 0x0d, 0x00, 0x28, 0x00 });

    constexpr file_tag null_obj_tag = platform::to_tag<4>({ 0x0e, 0x00, 0x14, 0x00 });
    constexpr file_tag poly_tag = platform::to_tag<4>({ 0x01, 0x00, 0x14, 0x00 });
    constexpr file_tag solid_poly_tag = platform::to_tag<4>({ 0x02, 0x00, 0x14, 0x00 });
    constexpr file_tag texture_for_poly_tag = platform::to_tag<4>({ 0x0f, 0x00, 0x14, 0x00 });
    constexpr file_tag shaded_polygon_tag = platform::to_tag<4>({ 0x03, 0x00, 0x14, 0x00 });
    constexpr file_tag gourand_poly_tag = platform::to_tag<4>({ 0x09, 0x00, 0x14, 0x00 });
    constexpr file_tag alias_solid_poly_tag = platform::to_tag<4>({ 0x10, 0x00, 0x14, 0x00 });
    constexpr file_tag alias_shaded_poly_tag = platform::to_tag<4>({ 0x11, 0x00, 0x14, 0x00 });
    constexpr file_tag alias_gourand_poly_tag = platform::to_tag<4>({ 0x12, 0x00, 0x14, 0x00 });
    constexpr file_tag group_tag = platform::to_tag<4>({ 0x14, 0x00, 0x14, 0x00 });
    constexpr file_tag bsp_group_tag = platform::to_tag<4>({ 0x0a, 0x00, 0x14, 0x00 });
    constexpr file_tag base_part_tag = platform::to_tag<4>({ 0x05, 0x00, 0x14, 0x00 });
    constexpr file_tag bitmap_part_tag = platform::to_tag<4>({ 0x13, 0x00, 0x14, 0x00 });
    constexpr file_tag part_list_tag = platform::to_tag<4>({ 0x07, 0x00, 0x14, 0x00 });
    constexpr file_tag cell_anim_part_tag = platform::to_tag<4>({ 0x0b, 0x00, 0x14, 0x00 });
    constexpr file_tag detail_part_tag = platform::to_tag<4>({ 0x0c, 0x00, 0x14, 0x00 });
    constexpr file_tag bsp_part_tag = platform::to_tag<4>({ 0x15, 0x00, 0x14, 0x00 });
    constexpr file_tag shape_tag = platform::to_tag<4>({ 0x08, 0x00, 0x14, 0x00 });
    constexpr file_tag an_sequence_tag = platform::to_tag<4>({ 0x01, 0x00, 0x1e, 0x00 });
    constexpr file_tag an_cyclic_sequence_tag = platform::to_tag<4>({ 0x04, 0x00, 0x1e, 0x00 });
    constexpr file_tag an_anim_list_tag = platform::to_tag<4>({ 0x02, 0x00, 0x1e, 0x00 });
    constexpr file_tag an_shape_tag = platform::to_tag<4>({ 0x03, 0x00, 0x1e, 0x00 });
    constexpr file_tag dc_shape_tag = platform::to_tag<4>({ 0xf8, 0x01, 0xbc, 0x02 });
    constexpr file_tag dc_shape_instance_tag = platform::to_tag<4>({ 0xf5, 0x01, 0xbc, 0x02 });
