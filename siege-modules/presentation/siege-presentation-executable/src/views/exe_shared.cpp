    ...
    auto configure_environment = [&]() {
          ...
          }))
      {
        if (has_client_preference(state))
        {
          ...
          ::SetEnvironmentVariableA("SIEGE_WSOCK_NODE_AUTH_KEY", self.registry_data.last_zero_tier_client_node_id_and_private_key.data());
        }
        else
        {
          ::SetEnvironmentVariableA("SIEGE_WSOCK_NODE_AUTH_KEY", self.registry_data.last_zero_tier_server_node_id_and_private_key.data());
        ...
        auto zt_path = *zt_ext_path / "wsock-backend-zero-tier.dll";
        fs::copy_file(zt_path, ext_path / "wsock-backend-zero-tier.dll", fs::copy_options::overwrite_existing, last_errorc);
      ...
      if (!stl::any_of(game_args.environment_settings, zt_is_enabled))
      {
        ...
        ::SetEnvironmentVariableA("SIEGE_WSOCK_NODE_AUTH_KEY", nullptr);
