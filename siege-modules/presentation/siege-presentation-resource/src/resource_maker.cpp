...
namespace siege::resource
{
  ...
  {
    return vol::darkstar::vol_resource_reader::stream_is_supported(stream) || vol::three_space::vol_resource_reader::stream_is_supported(stream) || vol::three_space::dyn_resource_reader::stream_is_supported(stream) || vol::three_space::rmf_resource_reader::stream_is_supported(stream) || vol::three_space::vol_resource_reader::stream_is_supported(stream) || vol::trophy_bass::rbx_resource_reader::stream_is_supported(stream) || vol::trophy_bass::tbv_resource_reader::stream_is_supported(stream) || pak::stream_is_supported(stream) || clm::clm_resource_reader::stream_is_supported(stream) || cln::cln_resource_reader::stream_is_supported(stream) || atd::atd_resource_reader::stream_is_supported(stream) || wad::wad_resource_reader::stream_is_supported(stream) || rsc::rsc_resource_reader::stream_is_supported(stream) || res::res_resource_reader::stream_is_supported(stream) || mw4::mw4_resource_reader::stream_is_supported(stream) || prj::prj_resource_reader::stream_is_supported(stream) || zip::stream_is_supported(stream) || cab::stream_is_supported(stream) || iso::stream_is_supported(stream);
  }
