...
namespace siege::views
{
  ...
  sfx_view::sfx_view(siege::platform::file_info info, std::istream& image_stream, const siege::resource::resource_explorer& explorer)
    : explorer(explorer), info(info)
  {
    ...
    if (siege::content::sfx::is_sfx_file(image_stream))
    {
    ...
    else if (siege::content::sfx::is_wav_file(image_stream) || siege::content::sfx::is_ogg_file(image_stream) || siege::content::sfx::is_flac_file(image_stream))
    {
      std::stringstream mem_buffer;
