...
extern "C"
{
    extern const std::uint32_t DefaultFileIcon = SIID_DOCASSOC;
    ...
    HRESULT __stdcall GetSupportedExtensions(_Outptr_ win32::com::IReadOnlyCollection** formats) noexcept
    {
        ...
        static std::vector<std::wstring_view> supported_extensions = []{
                ...
                std::copy(cfg_controller::formats.begin(), cfg_controller::formats.end(), std::back_inserter(extensions));
                return extensions;
            }();
...
;
    ...
    HRESULT __stdcall GetSupportedExtensionsForCategory(_In_ const wchar_t* category, _Outptr_ win32::com::IReadOnlyCollection** formats) noexcept
    {
        ...
        {
          *formats = std::make_unique<win32::com::ReadOnlyCollectionRef<std::wstring_view, decltype(cfg_controller::formats)>>(cfg_controller::formats).release();
        }
        else
        {
