...
extern auto template_configuration_paths = std::array<const wchar_t*, 3>{ { L"BaseEF/pak0.pak/default.cfg", L"BaseEF/default.cfg" } };
extern auto autoexec_configuration_paths = std::array<const wchar_t*, 4>{ { L"BaseEF/autoexec.cfg" } };
extern auto profile_configuration_paths = std::array<const wchar_t*, 4>{ { L"BaseEF/config.cfg" } };
...
constexpr std::array<std::array<std::pair<std::string_view, std::size_t>, 3>, 1> verification_strings = { { std::array<std::pair<std::string_view, std::size_t>, 3>{ { 
  { "exec"sv, std::size_t(0x48b3b4) },
  { "cmdlist"sv, std::size_t(0x48b3bc) },
  { "cl_pitchspeed"sv, std::size_t(0x48a3f0) } } } } };
...
constexpr static std::array<std::pair<std::string_view, std::string_view>, 5> function_name_ranges{ {
  ...
  { "endholodeckmenu"sv, "configstrings"sv },
} };
...
{
  ConsoleEvalCdecl = (decltype(ConsoleEvalCdecl))0x410e00;
}
  ...
  get_predefined_string_command_line_settings(const wchar_t* name) noexcept
{
  ...
  {
    return get_predefined_id_tech_3_map_command_line_settings(L"BaseEF");
  }
