...
extern auto template_configuration_paths = std::array<const wchar_t*, 3>{ { L"maintt/pak0.pak/default.cfg", L"maintt/default.cfg" } };
extern auto autoexec_configuration_paths = std::array<const wchar_t*, 4>{ { L"maintt/autoexec.cfg" } };
extern auto profile_configuration_paths = std::array<const wchar_t*, 4>{ { L"maintt/configs/*.cfg", L"maintt/configs/unnamedsoldier.cfg" } };
...
constexpr std::array<std::array<std::pair<std::string_view, std::size_t>, 1>, 1> verification_strings = { { std::array<std::pair<std::string_view, std::size_t>, 1>{ {
  { "Medal of Honor Allied Assault(TM) Breakthrough"sv, std::size_t(0x57cf90) },
} } } };
  ...
  get_predefined_string_command_line_settings(const wchar_t* name) noexcept
{
  ...
  {
    return get_predefined_id_tech_3_map_command_line_settings(L"mainta");
  }
