...
bool CreateDeviceD3D(Siege_RenderContext& self, HWND hWnd);
void CreateRenderTarget(Siege_RenderContext& self);
...
std::shared_ptr<Siege_RenderContext> Siege_Init(SDL_Window* window)
{
  ...
  std::shared_ptr<Siege_RenderContext> context = std::make_shared<Siege_RenderContext>();
...
void Siege_Resize(Siege_RenderContext& self)
{
...
void Siege_RenderReset(Siege_RenderContext& self, ImVec4 clear_color)
{
...
void Siege_RenderPresent(Siege_RenderContext& self)
{
