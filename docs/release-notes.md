...
* Fixed regression where .tbv and .rbx archives failed to open.
...
* Siege Launcher update disabled as it doesn't currently function because no update files are hosted.
